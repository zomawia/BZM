...
* 
*/
class BZMCharacterInfo_Playable_PeasantRevolt extends AOCCharacterInfo_Playable_PeasantRevolt;
...
defaultproperties
{
	...
	GearData=(GroupHexID="1700000003F72EC", MicroTxID=101038, GearNameID=RevoltingPeasant,bVisibleInSelectorIfUnowned=true, GearStoreDescriptionID=PeasantsRevoltSkinDesc)
