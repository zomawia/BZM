...
* 
*/
class BZMCharacterInfo_Playable_Peasant extends AOCCharacterInfo_Playable_Peasant;
...
defaultproperties
{
	...
	GearData=(AppID=222360,GearNameID=Peasant,bVisibleInSelectorIfUnowned=false)
