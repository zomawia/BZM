...
* cuir boilli
*/
class BZMCharacterInfo_ArmorLight_Cuir extends AOCCharacterInfo_ManAtArms;
...
//
	...
	//Helmets.Add((SkeletalMeshPath="PD2_maa_chains.sk_chains_agatha",             StaticMeshPath="PD2_maa_chains.sm_chains_agatha",          GearData=(GearNameID=PD2_AgathaChains, bVisibleInSelectorIfUnowned=true, AppidNoDLC=218620, GearStoreDescriptionID=PAYDAY2_Item_Set_Description)))
//
