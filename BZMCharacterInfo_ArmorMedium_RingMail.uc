...
* 
*/
class BZMCharacterInfo_ArmorMedium_RingMail extends AOCCharacterInfo_Vanguard;
...
//
	...
	//GearData=(GearNameID=BarbMasonVanguard, GearStoreDescriptionID=Barb_Vanguard_Bundle_1, MicroTxID=101023, bVisibleInSelectorIfUnowned=true, bPartOfBundle=true, BundleNameID=Barb_Vanguard_Bundle_1)
//
	//AllowedTeams.Add(1)
//
	///** Customizables **/
