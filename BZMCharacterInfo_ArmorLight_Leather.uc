...
* Mason MAA
*/
class BZMCharacterInfo_ArmorLight_Leather extends AOCCharacterInfo_ManAtArms;
...
defaultproperties
{
	...
	//Helmets.Add((SkeletalMeshPath="PD2_maa_chains.sk_chains_mason",             StaticMeshPath="PD2_maa_chains.sm_chains_mason",          GearData=(GearNameID=PD2_MasonChains, bVisibleInSelectorIfUnowned=true, AppidNoDLC=218620, GearStoreDescriptionID=PAYDAY2_Item_Set_Description)))
//
