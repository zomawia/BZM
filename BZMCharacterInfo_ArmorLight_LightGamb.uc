...
* 
*/
class BZMCharacterInfo_ArmorLight_LightGamb extends AOCCharacterInfo_Archer;
...
//
	...
	//Helmets.Add((SkeletalMeshPath="pd2_archer_hoxton.sk_hoxton_mason",             StaticMeshPath="pd2_archer_hoxton.sm_hoxton_mason",            GearData=(GearNameID=PD2_MasonHoxton, bVisibleInSelectorIfUnowned=true, AppidNoDLC=218620, GearStoreDescriptionID=PAYDAY2_Item_Set_Description)))
//
